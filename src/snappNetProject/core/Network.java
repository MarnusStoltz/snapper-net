...
public class Network extends StateNode {
    ...
    public void test_initAndValidate() {
        if (nodeCount < 0) {
            if (taxonSet != null) {
                test_makeCaterpillar(0, 1);
                updateRelationships();
            } else {
                makeDummy();
            }
    ...
    public void test_makeCaterpillar(final double minInternalHeight, final double step) {
        // make a caterpillar
        final List<String> taxa = taxonSet.asStringList();
