...
//	public Input<Tree> m_pTree = new Input<Tree>("tree", "tree with phylogenetic relations");
	...
	public Input<Integer> NInput = new Input<Integer>("N", "dimension of Chebyshef functions used, should be power of 2 plus 1. Higher values are more accurate but slower", 9);
...
//	double [] fStoredSiteProbs;
	...
	private void calcPatternPoints(int nPatterns) {
		...
		}myNodeToTreat.gammaBranchNumber
    }
	/**
...
//  int_sum = D[j,-1]
//  for i in range(0,n):log_int_beta_xn
